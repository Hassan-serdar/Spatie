<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <a href="{{ route('roles.index') }}" class="bg-slate-700 text-sm rounded-md text-white px-3 py-2">Roles List</a>
        </div>    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('roles.update',$role->id) }}" method="POST">
                        ...
                        <div>
                            ...
                            <div class="my-3">
                                <input name="name" value="{{old('name',$role->name)}}" type="text" placeholder="Enter Name"
